...
#
# Usage:
#   bash submit_fuse_eval.sh [method] [eval_scheme] [control] [fusion_llm] [normalization]
#
# Examples:
...
LOGDIR=$UNIFIED/slurm_logs/fuse_eval_${METHOD}_${EVAL_SCHEME}_${NORM}_ctrl_${CONTROL}
mkdir -p "$LOGDIR"
